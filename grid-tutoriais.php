                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
                        ...
                        <div class="archive-catagory">
                            <h4><i class="fa fa-rocket" aria-hidden="true"></i> Tutoriais</h4>
                        </div>
                        <!-- View Options -->
                        <div class="view-options">
                            <a href="grid-tutoriais.php" class="active"><i class="fa fa-th-large" aria-hidden="true"></i></a>
                            <a href="list-tutoriais.php"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                ...
                                <div class="post-content">
                                    <a href="#" class="post-cata cata-sm cata-dotas">Tutoriais</a>
