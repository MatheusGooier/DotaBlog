                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
                        ...
                        <div class="archive-catagory">
                            <h4><i class="fa fa-trophy" aria-hidden="true"></i> Campeonatos</h4>
                        </div>
                        <!-- View Options -->
                        <div class="view-options">
                            <a href="grid-campeonatos.php" class="active"><i class="fa fa-th-large" aria-hidden="true"></i></a>
                            <a href="list-campeonatos.php"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
                        </div>
                    </div>
